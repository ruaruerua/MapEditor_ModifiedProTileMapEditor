	...
	private void Update()
	{
      ...
      //  #endif*/
		...
		if(isMiddleButtonPressed)
		{
			...
			transform.Translate(new Vector3(((float)-pX)*0.7f * cameraSensitivity,0,((float)-pY)*0.7f * cameraSensitivity) * 1f);
		}
		...
		{
			transform.Translate(new Vector3(((float)-Input.GetAxis( "Mouse X" ))*0.7f * cameraSensitivity,0,((float)-Input.GetAxis( "Mouse Y" ))*0.7f * cameraSensitivity) * 1f);
		}
